          ...
          {isOpen && (
            ...
            >
              ...
              <div className="space-y-2">
                {navigationData.sideNav.helpSupport.contacts.map((contact, index) => {
                  const IconComponent = getIcon(contact.icon);
                  return (
                    <motion.a
                      key={index}
                      href={contact.type === 'email' ? `mailto:${contact.value}` : contact.type === 'whatsapp' ? `https://wa.me/${contact.value.replace(/[^0-9]/g, '')}` : '#'}
                      initial={{ x: -20, opacity: 0 }}
                      animate={{ x: 0, opacity: 1 }}
            ...
            >
              ...
              <div className="space-y-2">
                {navigationData.sideNav.partnerships.contacts.map((contact, index) => {
                  const IconComponent = getIcon(contact.icon);
                  return (
                    <motion.a
                      key={index}
            ...
            >
              ...
              <div className="flex gap-3 flex-wrap">
                {navigationData.sideNav.socialMedia.platforms.map((platform, index) => {
                  ...
                  return (
                    <motion.a
                      ...
                      transition={{ delay: 0.55 + (index * 0.05), duration: 0.3, type: "spring" }}
                      whileHover={{ scale: 1.1, rotate: 5 }}
                      whileTap={{ scale: 0.95 }}
            ...
            >
              ...
              <div className="space-y-2">
                {navigationData.sideNav.downloadApp.apps.map((app, index) => {
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <span className="sidebar-text text-black text-sm">
                    {navigationData.sideNav.region.current.country} ({navigationData.sideNav.region.current.currency})
                  </span>
                  <p className="sidebar-text text-xs text-gray-500">
                    {navigationData.sideNav.region.current.flag} {navigationData.sideNav.region.current.code}
                  </p>
                </div>
              </div>
            </motion.div>
