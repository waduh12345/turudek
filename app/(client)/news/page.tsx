...
// ... (Interface NewsItem tidak berubah) ...
interface NewsItem {
  id: number;
  title: string;
  image: string;
...
const NewsPage = () => {
  // ... (Data (newsData, tutorialsData, dll) tidak berubah) ...
  ...
  const promoData: NewsItem[] = [
    {
      id: 19,
      title:
        "Turu Store.com Gelar Event Spesial HUT RI ke-80: Belanja Rp170.000 Dapat Voucher Rp17.000!",
      image:
    ...
    },
    {
      id: 20,
      title:
        "Nikmati Diskon Rp10.000 di Turu Store dengan Pembayaran QRIS Neobank",
      image:
    ...
    },
    {
      id: 21,
      title:
        "Liburan Seru Bareng Turu Store! Ikuti Giveaway dan Menangkan Voucher 30K!",
      image:
    ...
    {
      id: 23,
      title: "Ikuti Giveaway Turu Store Spesial Hari Konsumen Nasional 2025",
      image:
        "https://images.unsplash.com/photo-1574375927938-d5a98e8ffe85?w=400&h=250&fit=crop&crop=center",
      date: "2025-01-11",
      category: "Giveaway",
    ...
    {
      id: 24,
      title: "Ikuti Event Turu Store Bagi-Bagi THR Hingga 900.000",
      image:
        "https://images.unsplash.com/photo-1607082349566-187342175e2f?w=400&h=250&fit=crop&crop=center",
      date: "2025-01-10",
      category: "Event",
  ...
  return (
    // [DIUBAH] Latar belakang utama disesuaikan dengan palet Turu Store
    <div className="min-h-screen bg-[#17181d] relative overflow-hidden">
      {/* Background Pattern */}
      {/* [DIUBAH] Glow disesuaikan dengan palet Kuning, Cyan, dan Ungu */}
      ...
      {/* Grid Pattern (Netral, bisa dipertahankan) */}
...
const CarouselSection = () => {
  // ... (Logika state (slideCount, carouselData) tidak berubah) ...
  ...
  // ... (Logika (sliderVariants, sliderTransition, swipeToSlide, nextSlide, prevSlide, skipToSlide, useEffect) tidak berubah) ...
  ...
  return (
    <div className="relative h-[600px] overflow-hidden">
                ...
                <div className="max-w-2xl">
                  <div>
                    {carouselData[activeSlideIndex].trending && (
                      // [DIUBAH] Trending badge disesuaikan dengan aksen Kuning
                      <div className="inline-flex items-center gap-2 bg-yellow-400 text-slate-900 px-4 py-2 rounded-full text-sm font-bold mb-4">
                        <TrendingUp size={16} />
                        <span>TRENDING</span>
                      </div>
                    )}

                    {/* [DIUBAH] Category badge disesuaikan dengan aksen Cyan */}
                    <div className="bg-white/10 backdrop-blur-sm px-4 py-2 rounded-lg text-cyan-400 text-sm font-semibold mb-4 inline-block">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                      {/* [DIUBAH] Tombol CTA Utama disesuaikan dengan aksen Kuning */}
                      <button className="bg-yellow-400 hover:bg-yellow-500 text-slate-900 px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 shadow-lg hover:shadow-xl">
                        Baca Selengkapnya
                      </button>
      ...
      {/* ... (Navigation Arrows & Dots Indicator tidak berubah, sudah netral) ... */}
      <motion.button
...
const ContentSections = ({
  ...
  // ... (Helper (formatDate, formatViews) tidak berubah) ...
  ...
  const NewsCard = ({
    ...
    const getSectionColors = (type: string) => {
      switch (type) {
        ...
        // [DIUBAH] Esports (Orange) -> Yellow (Aksen Utama)
        case "esports":
          return {
            cardBg: "bg-gradient-to-br from-yellow-50 via-white to-amber-50",
            borderColor: "border-yellow-200/50",
            accentColor: "from-yellow-400 to-amber-500",
            hoverAccent: "hover:from-yellow-500 hover:to-amber-600",
        ...
        // [DIUBAH] Promo (Red) -> Gradien Khas Turu Store (Yellow/Cyan)
        case "promo":
          return {
            cardBg: "bg-gradient-to-br from-yellow-50 via-white to-cyan-50",
            borderColor: "border-yellow-200/50",
            accentColor: "from-yellow-400 to-cyan-500",
            hoverAccent: "hover:from-yellow-500 hover:to-cyan-600",
            textAccent: "text-yellow-500",
            badgeBg: "bg-gradient-to-r from-yellow-400 to-cyan-500",
            shadowColor: "shadow-yellow-100/50",
            hoverShadow: "hover:shadow-yellow-200/50",
          };
        default:
    ...
    return (
      <Link href={`/news/${slug}`}>
        ...
        >
          {/* ... (Gradient Overlay tidak berubah) ... */}
          <div
          ...
          <div className="relative overflow-hidden">
            ...
            />
            {/* ... (Image Overlay Gradient tidak berubah) ... */}
            ...
            {item.trending && (
              <motion.div
                ...
                // [DIUBAH] Trending badge disesuaikan dengan aksen Kuning
                className="absolute top-2 left-2 bg-yellow-400 text-slate-900 px-2 py-1 rounded-full text-xs font-bold flex items-center gap-1 shadow-lg"
                style={{
          ...
          <div className="relative p-4">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-1 bg-gray-100 px-2 py-1 rounded-full">
                  {/* [DIUBAH] Ikon disesuaikan dengan aksen Cyan */}
          ...
          {/* ... (Bottom Accent Line tidak berubah) ... */}
          <div
  ...
  const SectionHeader = ({
    ...
    >
      {/* ... (Background Pattern tidak berubah, sudah gelap) ... */}
      <div className="absolute inset-0 bg-gradient-to-r from-gray-900 via-black to-gray-900 rounded-2xl opacity-90" />
      {/* [DIUBAH] Glow disesuaikan dengan aksen Kuning/Cyan */}
      <div className="absolute inset-0 bg-gradient-to-r from-yellow-400/10 via-transparent to-cyan-400/10 rounded-2xl" />

      {/* Content */}
      <div className="relative flex items-center gap-6 p-6">
        {/* ... (Accent Line (color prop) tidak berubah) ... */}
        <div
          className={`w-2 h-16 bg-gradient-to-b ${color} rounded-full shadow-lg`}
        ></div>

        {/* ... (Icon Container (color prop) tidak berubah) ... */}
        <motion.div
        ...
        <div className="flex-1">
          ...
          {/* [DIUBAH] Gradien garis disesuaikan dengan brand Kuning/Cyan */}
          <div className="w-24 h-1 bg-gradient-to-r from-yellow-400 to-cyan-400 rounded-full" />
        </div>

        {/* Decorative Elements */}
        <div className="flex gap-2">
          {/* [DIUBAH] Titik-titik dekoratif disesuaikan dengan brand Kuning/Cyan/Ungu */}
          <motion.div
    ...
    <div className="container mx-auto px-4 py-16">
      ...
      >
        <SectionHeader
          title="NEWS & UPDATES"
          icon={TrendingUp}
          // [DIUBAH] Warna prop disesuaikan dengan aksen Cyan
      ...
      >
        <SectionHeader
          ...
          icon={BookOpen}
          // [TETAP] Warna prop (Ungu) sesuai dengan vibe
      ...
      >
        <SectionHeader
          title="E-SPORTS"
          icon={Trophy}
          // [DIUBAH] Warna prop disesuaikan dengan aksen Kuning
      ...
      >
        <SectionHeader
          ...
          icon={Gift}
          // [DIUBAH] Warna prop disesuaikan dengan gradien Khas Turu Store
