...
import { Calendar, Clock, Eye, ArrowRight, TrendingUp, BookOpen, Trophy, Gift, Newspaper, Gamepad2 } from "lucide-react";
...
const TagsPage = () => {
  ...
  const getTrendingNews = () => {
    return [
      ...
      },
      {
        ...
        image: "https://images.unsplash.com/photo-1511512578047-dfb367046420?w=150&h=100&fit=crop&crop=center",
        date: "2025-01-14"
      },
      {
        id: 3,
        title: "Valorant Champions 2025: Paper Rex Juara Asia!",
        image: "https://images.unsplash.com/photo-1614680376573-df3480f0c6ff?w=150&h=100&fit=crop&crop=center",
        date: "2025-01-13"
      }
    ];
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-green-100 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_80%,rgba(34,197,94,0.03),transparent_50%)]" />
          ...
          >
            ...
            <div className="flex items-center gap-4 mb-8">
              <motion.div 
                ...
                className={`p-4 rounded-2xl bg-gradient-to-br ${categoryData.color} shadow-2xl border border-green-200`}
                style={{
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-12">
              ...
              >
                <Link href={`/news/${categoryData.heroContent[0].title.toLowerCase().replace(/\s+/g, '-').replace(/[^a-z0-9-]/g, '')}`}>
                  <div className="group relative h-[500px] rounded-3xl overflow-hidden shadow-2xl cursor-pointer bg-white border border-green-200">
                    <Image
                    ...
                    <div className="absolute top-6 left-6 bg-white/90 backdrop-blur-sm px-4 py-2 rounded-lg shadow-lg">
                      <span className="text-lg font-bold text-gray-800">PUBG MOBILE</span>
                    </div>
                    ...
                    <div className="absolute top-20 right-6 bg-black/80 backdrop-blur-sm rounded-lg p-4 border border-green-400/30">
                      <div className="text-green-400 text-sm font-semibold mb-2">ASM ABAKAN</div>
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-8">
                      <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-6 shadow-xl">
                        <h2 className="text-3xl font-bold text-gray-900 mb-3 line-clamp-2 group-hover:text-green-600 transition-colors duration-300">
                        ...
                        <div className="flex items-center gap-3 text-sm text-gray-500">
                          <Calendar size={16} />
                          <span className="font-medium">{formatDate(categoryData.heroContent[0].date)}</span>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="lg:col-span-1 space-y-6">
                {categoryData.heroContent.slice(1, 3).map((item, index) => (
                  ...
                  >
                    <Link href={`/news/${item.title.toLowerCase().replace(/\s+/g, '-').replace(/[^a-z0-9-]/g, '')}`}>
                      <div className="group relative h-[240px] rounded-2xl overflow-hidden shadow-xl cursor-pointer bg-white border border-green-200">
                        <Image
                          src={item.image}
                          alt={item.title}
                          fill
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
              ...
              <div className="lg:col-span-3">
                <motion.div
                  ...
                  className="mb-8"
                >
                  <h2 className="text-3xl font-bold text-gray-900 mb-6">{categoryData.name}</h2>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                    {paginatedContent.map((item, index) => (
                      <motion.div
                        ...
                        className="group relative bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden border border-green-200 backdrop-blur-sm cursor-pointer"
                      >
                        <Link href={`/news/${item.title.toLowerCase().replace(/\s+/g, '-').replace(/[^a-z0-9-]/g, '')}`}>
                          {/* Image Container */}
                          ...
                          <div className="p-4">
                            {/* Title */}
                            <h3 className="font-bold text-gray-900 text-base leading-tight mb-3 group-hover:text-green-600 transition-colors duration-300 line-clamp-2">
                              {item.title}
                            </h3>
                            ...
                            <div className="flex items-center justify-between">
                              <div className="flex items-center text-green-600 font-semibold text-xs group-hover:text-green-700 transition-colors duration-300">
                  ...
                  <div className="flex justify-center mt-12">
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="px-4 py-2 bg-white text-gray-700 rounded-lg hover:bg-green-50 border border-green-200 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-300"
                      >
                        Previous
                      </button>
                  ...
                  <div className="space-y-4">
                    {getLatestNews().map((item) => (
                      <Link
                        ...
                        className="group flex gap-3 hover:bg-green-50 p-2 rounded-lg transition-colors duration-300"
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <h4 className="text-sm font-semibold text-gray-900 group-hover:text-green-600 transition-colors duration-300 line-clamp-2 mb-1">
                            {item.title}
                          </h4>
